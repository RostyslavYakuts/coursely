    ...
    <form id="checkout_form" method="post" class="brand-shadow mb-10 p-10 flex flex-col lgx:flex-row justify-between items-start gap-10 bg-white rounded-[40px] mt-[124px]">
        ...
        <div class="sign-up w-full py-5">
            @if ($is_user_logged_in)
                <h1 class="mt-5 font-bold text-[32px]">{{__('Update','coursely')}}</h1>
            @else
            ...
            <div class="mt-10">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" required placeholder="{{__('Enter first name','coursely')}}" type="text" id="subscriber_name" name="subscriber_name" value="{{$user_data['user_firstname'] ?? ''}}">
                ...
                <div class="input-block mt-4 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" required placeholder="{{__('Enter email address','coursely')}}" type="email" id="subscriber_email" name="subscriber_email" value="{{$user_data['user_email'] ?? ''}}">
                ...
                <div class="input-block mt-4 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" required placeholder="{{__('Enter phone number','coursely')}}" type="tel" id="subscriber_phone" name="subscriber_phone" value="{{$user_data['user_phone'] ?? ''}}">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="{{__('Enter company name','coursely')}}" type="text" id="subscriber_company_name" name="subscriber_company_name" value="{{$user_data['user_company'] ?? ''}}">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input required class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="{{__('Enter street address','coursely')}}" type="text" id="subscriber_street_address" name="subscriber_street_address" value="{{$user_data['user_address_line_1'] ?? ''}}">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="{{__('Enter street address 2','coursely')}}" type="text" id="subscriber_street_address_2" name="subscriber_street_address_2" value="{{$user_data['user_address_line_2'] ?? ''}}">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input required class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="{{__('Enter city','coursely')}}" type="text" id="subscriber_city" name="subscriber_city" value="{{$user_data['user_city'] ?? ''}}">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <select required class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" type="text" id="subscriber_country" name="subscriber_country">
                        <option value="{{$user_data['user_country_code'] ?? ''}}">{{$user_data['user_country'] ?? ''}}</option>
                ...
                <div class="mt-5 flex flex-col lgx:flex-row lgx:justify-between lgx:items-center gap-5">
                    <div class="input-block relative flex flex-col gap-1">
                        ...
                        <input required class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="{{__('Enter state','coursely')}}" type="text" id="subscriber_state" name="subscriber_state" value="{{$user_data['user_state'] ?? ''}}">
                    ...
                    <div class="input-block relative flex flex-col gap-1">
                        ...
                        <input required class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="{{__('Enter postcode','coursely')}}" type="text" id="subscriber_zip" name="subscriber_zip" value="{{$user_data['user_postal_code'] ?? ''}}">
                ...
                <div id="checkout_payment" class="mt-5">
                    <div class="input-block relative flex flex-col gap-1">
                        ...
                        <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="{{__('Enter cardholder name','coursely')}}" type="text" id="subscriber_cardholder_name" name="subscriber_cardholder_name" value="{{$user_data['user_cardholder_name'] ?? ''}}">
                    ...
                    <div class="mt-5 grid grid-cols-1 lgx:grid-cols-2 gap-4">
                        ...
                        <div class="input-block relative flex flex-col gap-1">
                            <span class="font-medium">{{__('CVC','coursely')}}<sup class="text-brand">*</sup></span>
