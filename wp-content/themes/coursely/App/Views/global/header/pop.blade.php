    ...
    <div class="w-full h-full flex justify-center items-center">
        ...
        <div class="relative popup-content w-full max-w-[1096px] bg-white rounded-[40px] p-[40px]">
            ...
            <div class="flex justify-between gap-[32px] ">
                <img src="{{$options['login_popup_image']['url']}}"
                     alt="{{$options['login_popup_image']['alt']}}"
                ...
                <form id="login_form" class="auth-form-js  w-full max-w-[492px] hidden" method="post">
                    <span class="h3 font-bold text-[32px]">{{__('Log In','coursely')}}</span>
                    <fieldset class="mt-5 flex flex-col gap-1">
                        <label for="login_user_email" class="font-medium">
                            {{__('Email address','coursely')}}
                            <span class="text-brand">*</span>
                        </label>
                        <input class="w-full border border-gray text-brand-light-gray py-2.5 px-3 rounded-lg" type="email" placeholder="{{__('Enter email address','coursely')}}" id="login_user_email" name="login_user_email">
                    ...
                    <fieldset class="mt-5 flex flex-col gap-1">
                        ...
                        <div class="relative">
                            <input class="w-full border border-gray text-brand-light-gray py-2.5 px-3 rounded-lg" type="password" placeholder="{{__('Enter password','coursely')}}" id="login_user_password" name="login_user_password">
                        ...
                        <div class="flex justify-end">
                            <button type="button" class="underline text-sm text-brand-light-gray hover:text-brand">
                                {{__('Forget your password','coursely')}}
                            </button>
                        </div>
                    ...
                    <span class="mt-[32px] block text-center">
                        {{__('Don`t have an account?','coursely')}}
                        <a href="/pricing" type="button" class="underline hover:text-brand">{{__('Sign up')}}</a>
                    </span>
