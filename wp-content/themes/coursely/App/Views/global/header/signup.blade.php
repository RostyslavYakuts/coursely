...
<form id="signup_form" class="auth-form-js w-full max-w-[492px] hidden" method="post">
    ...
    <fieldset class="mt-5 flex flex-col gap-1">
        <label for="signup_user_password">{{__('Password','coursely')}}<span class="text-brand">*</span></label>
        <div class="relative">
            ...
            <button type="button" data-input="signup_user_password" class="togglePassword absolute top-[14px] right-[14px]">
