...
<?php
     ...
     * @var array $data
     */
    $is_user_subscription_active = $data['is_user_subscription_active'];

?>
<?php if($is_user_subscription_active): ?>
<div class="active-subscription w-full lgx:w-[406px] lgx:min-w-[406px] lgx:h-[365px] mt-14 bg-white rounded-[20px] brand-shadow p-5 lgx:py-8 lgx:px-6 flex flex-col">
    <h3 class="leading-none font-bold text-[24px]"><?php echo e(__('Click to Start learning now','coursely')); ?></h3>
    <div class="mt-8 flex bg-[#EBFAF5] rounded-[10px] p-3">
        <span class="text-lg">
            <?php echo e(__('This course is already included in your subscription.','coursely')); ?>
...
<?php endif; ?><?php /**PATH /var/www/html/wp-content/themes/coursely/App/Views/single/course/subscribe-banner.blade.php ENDPATH**/ ?>