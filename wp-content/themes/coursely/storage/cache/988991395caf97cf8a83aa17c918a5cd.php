...
<div class="account-tabs-content-item subscription min-h-[626px]">
    <h2 class="leading-0 font-bold text-[20px] lgx:text-[32px] flex items-center gap-2">
        ...
        <?php echo e(__('Subscription & Payments','coursely')); ?>
            ...
            <?php $__currentLoopData = $data['invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="invoice grid grid-cols-5 text-sm">
                    ...
                    <div class="p-3">
                        ...
                        ?>
                        <?php echo e($created_date->format('F j, Y')); ?>

                    </div>
                    <div class="p-3">
                                    <span class="invoice-status <?php echo e($invoice['status']); ?>">
                    ...
                    <div class="p-3">$<?php echo e($invoice['total']); ?></div>
                    <div class="p-3"><?php echo e($invoice['plan_name']); ?></div>
                </div>
            ...
            <?php $__currentLoopData = $data['invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="invoice flex flex-col gap-2 text-sm">
                    <div class="p-2 flex justify-between items-center">
                        <span>Invoice</span>
                        <span><?php echo e($invoice['stripe_invoice_id']); ?></span>
                    </div>
                    <div class="p-2 flex justify-between items-center">
                        ...
                        <?php
                            $created_date = new \DateTime($invoice['created_at']);
                        ?>
                        <span> <?php echo e($created_date->format('F j, Y')); ?></span>
                    </div>
                    <div class="p-2 flex justify-between items-center">
                        <span>Status</span>
                        <span class="invoice-status <?php echo e($invoice['status']); ?>">
                    ...
                    <div class="p-2 flex justify-between items-center">
                        <span>Amount</span>
                        <span>$<?php echo e($invoice['total']); ?></span>
                    </div>
                    <div class="p-2 flex justify-between items-center">
                        <span>Plan</span>
                        <span><?php echo e($invoice['plan_name']); ?></span>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
...
<?php /**PATH /var/www/html/wp-content/themes/coursely/App/Views/page/account/subscription.blade.php ENDPATH**/ ?>