        ...
        <div class="sign-up w-full py-5">
            ...
            <div class="mt-10">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" required placeholder="<?php echo e(__('Enter first name','coursely')); ?>" type="text" id="subscriber_name" name="subscriber_name">
                ...
                <div class="input-block mt-4 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" required placeholder="<?php echo e(__('Enter email address','coursely')); ?>" type="email" id="subscriber_email" name="subscriber_email">
                ...
                <div class="input-block mt-4 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" required placeholder="<?php echo e(__('Enter phone number','coursely')); ?>" type="tel" id="subscriber_phone" name="subscriber_phone">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="<?php echo e(__('Enter company name','coursely')); ?>" type="text" id="subscriber_company_name" name="subscriber_company_name">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input required class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="<?php echo e(__('Enter street address','coursely')); ?>" type="text" id="subscriber_street_address" name="subscriber_street_address">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="<?php echo e(__('Enter street address 2','coursely')); ?>" type="text" id="subscriber_street_address_2" name="subscriber_street_address_2">
                ...
                <div class="input-block mt-5 relative flex flex-col gap-1">
                    ...
                    <input required class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="<?php echo e(__('Enter city','coursely')); ?>" type="text" id="subscriber_city" name="subscriber_city">
                ...
                <div class="mt-5 flex justify-between items-center gap-5">
                    <div class="input-block relative flex flex-col gap-1">
                        ...
                        <input required class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="<?php echo e(__('Enter state','coursely')); ?>" type="text" id="subscriber_state" name="subscriber_state">
                    ...
                    <div class="input-block relative flex flex-col gap-1">
                        ...
                        <input required class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="<?php echo e(__('Enter postcode','coursely')); ?>" type="text" id="subscriber_zip" name="subscriber_zip">
                ...
                <div id="checkout_payment" class="mt-5">
                    <div class="input-block relative flex flex-col gap-1">
                        ...
                        <input class="bg-transparent rounded-lg active:border-brand h-[44px] py-[10px] px-[12px] border border-gray" placeholder="<?php echo e(__('Enter cardholder name','coursely')); ?>" type="text" id="subscriber_cardholder_name" name="subscriber_cardholder_name">
