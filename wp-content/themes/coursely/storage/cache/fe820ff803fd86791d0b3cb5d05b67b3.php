...
<section id="testimonials" class="w-full mt-[120px]">
    <div class="container mx-auto">
        <h2 class="text-center text-brand-dark text-[32px] lgx:text-[48px] "><?php echo e($data['testimonials_title']); ?></h2>
        <p class="mt-5 text-lg text-brand-text text-center"><?php echo e($data['testimonials_description']); ?></p>
                                    ...
                                    <div class=" flex justify-between items-center">
                                        <div class="flex flex-row gap-5">
                                            ...
                                            <div class="flex flex-col gap-1">
                                                <span class="text-base font-semibold xmm:text-lg text-brand-dark"><?php echo e($testimonial['name']); ?></span>
                                                <span class="text-sm xmm:text-base text-[#66708599]"><?php echo e($testimonial['role']); ?></span>
                                            </div>
...
</section><?php /**PATH /var/www/html/wp-content/themes/coursely/App/Views/page/home/testimonials.blade.php ENDPATH**/ ?>