                ...
                <div class="brand-shadow plan bg-white rounded-[20px] py-8 px-6 w-full flex flex-col gap-5"
                    ...
                    <div class="flex justify-between items-center gap-2">
                        ...
                        <span class="font-medium text-xs rounded-[8px] bg-brand text-white py-1.5 px-2">
                            <?php echo e(__('Current plan','coursely')); ?>
...
<?php endif; ?>
<?php if($data['plans'] && !$active_plan): ?>
    <div class="container">
        <div class="plans-wrapper mt-16 grid grid-cols-1 md:grid-cols-2 lgx:grid-cols-4 gap-5">
            <?php $__currentLoopData = $data['plans']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="brand-shadow plan <?php echo e($plan['is_popular'] ? 'bg-brand-dark lgx:-mt-5 lgx:mb-5' :'bg-white'); ?> rounded-[20px] py-8 px-6 w-full flex flex-col gap-5 <?php echo e($plan['is_popular'] ?? 'popular'); ?>"
                     data-type="<?php echo e($plan['type']); ?>">
