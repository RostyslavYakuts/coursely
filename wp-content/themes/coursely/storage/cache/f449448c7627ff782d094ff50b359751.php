...
<section class="container">
            ...
            <?php if($data['categories']): ?>
                <div class="categories w-full">
                    <?php $__currentLoopData = $data['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($category['link']); ?>" class="rounded-full text-center bg-[#0158D81A] font-medium py-1.5 px-2.5 ">
                ...
                <div class="mt-5 rating-wrapper flex flex-row items-center gap-2">
                    ...
                    <span class="font-medium text-sm"><?php echo e($data['rating']); ?></span>
                </div>
    ...
    <div class="lgx:px-8 content gap-5 flex flex-col lgx:flex-row items-start ">
        ...
        <?php echo $__env->make('single.course.subscribe-banner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
