...
<div class="account-tabs-content-item active profile-settings h-[626px]">
    <h2 class="leading-0 font-bold text-[20px] lgx:text-[32px] flex items-center gap-2">
        ...
        <?php echo e(__('Profile Settings','coursely')); ?>
    ...
    <form id="profile_settings_edit" class="mt-8 flex flex-col gap-5">
        <div class="fieldset user-image">
            <label class="cursor-pointer font-medium block relative w-[120px] max-w-[120px]" for="user_photo">
                ...
                <span class="block pb-1.5"><?php echo e(__('Profile image')); ?></span>
                <picture id="user_image_wrapper">
                    <?php if($data['user_photo']): ?>
                        <img class="rounded-full object-cover w-[120px] h-[120px]"
                             src="<?php echo e($data['user_photo']['url']); ?>"
                             alt="user-<?php echo e($data['user_id']); ?>" width="120" height="120" loading="lazy" decoding="async">
                    <?php else: ?>
        ...
        <div class="fieldset flex flex-col gap-2 w-full">
            <label class="font-medium block" for="user_first_name">
                <?php echo e(__('First Name','coursely')); ?>

            </label>
            <input class="rounded-[8px] border border-gray py-2.5 px-3" type="text" name="user_first_name" id="user_first_name" placeholder="<?php echo e($data['first_name']); ?>" value="<?php echo e($data['first_name']); ?>">
        </div>
        <div class="fieldset flex flex-col gap-2 w-full">
            <label class="font-medium block" for="user_last_name">
                <?php echo e(__('Last Name','coursely')); ?>

            </label>
            <input class="rounded-[8px] border border-gray py-2.5 px-3" type="text" name="user_last_name" id="user_last_name" placeholder="<?php echo e($data['last_name']); ?>" value="<?php echo e($data['last_name']); ?>">
        </div>
        <div class="fieldset flex flex-col gap-2 w-full">
            <label class="font-medium block" for="user_email">
                <?php echo e(__('Current Email Address','coursely')); ?>

            </label>
            <input class="rounded-[8px] border border-gray py-2.5 px-3" type="text" name="user_email" id="user_email" placeholder="<?php echo e($data['email']); ?>" value="<?php echo e($data['email']); ?>">
        </div>
...
</div><?php /**PATH /var/www/html/wp-content/themes/coursely/App/Views/page/account/profile.blade.php ENDPATH**/ ?>